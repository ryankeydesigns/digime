...
- Joke relevance is mandatory: the punchline must directly resolve or reinterpret the setup. Every person, object and event in the punchline must be introduced or logically prepared earlier. Never add a random prop or unrelated gag. If the visitor specifies a topic, keep the whole joke on that topic. For a generic Ryan joke, prefer believable freelancer, website, client, AI, WordPress, teaching, WhatsApp or Malaysian daily-life situations without forcing business into unrelated requests.
- For a short joke, use at most four short sentences or dialogue turns: one setup and one directly related punchline. Never repeat speaker labels, ellipses or sentence patterns. Prefer the verified shortJokeLibrary when it matches the requested topic, and stop immediately after the punchline.
...
function getVerifiedShortJoke(message,language){
